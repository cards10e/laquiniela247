...
const translations = {
  en: {
    ...
    betting: {
      ...
      all_bets_placed: "All bets placed successfully!",
      bets_placed_count: "You have placed %{placed} out of %{total} predictions",
      week_summary: "Week Summary",
      wait_for_results: "Waiting for results",
      ...
      betting_closed_at: "Betting Closed At",
      deadline_passed: "Deadline Passed",
      total_bet_amount: "Total Bet Amount",
      number_of_weeks_bet: "Number of Weeks Bet",
      total_active_players: "Total Active Players",
      place_selections: "Place Selections",
      games_available_to_bet: "Available Games for Betting",
    ...
    admin: {
      ...
      betting_closed: "Betting Closed",
      // Auto-update game status
      auto_game_status_management: "Automatic Game Status Updates",
      auto_game_status_description: "Automatically updates game statuses based on match times.",
      auto_game_status_info: "Scheduled → Live (at game time) → Completed (2.5 hours later)",
  ...
  es: {
    ...
    betting: {
      ...
      betting_closed_at: "Apuestas Cerradas",
      ...
      total_active_players: "Total de Jugadores Activos",
    ...
    admin: {
      ...
      match_completed: "Partido Completado",
      betting_available: "Apuestas Disponibles",
      betting_closes_soon: "Apuestas Cierran Pronto",
      betting_closed: "Apuestas Cerradas",
      // Auto-update game status
      auto_game_status_management: "Actualizaciones Automáticas de Estado",
      auto_game_status_description: "Actualiza automáticamente los estados de los juegos basándose en las horas de los partidos.",
      auto_game_status_info: "Programado → En Vivo (a la hora del juego) → Completado (2.5 horas después)",
